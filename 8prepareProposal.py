...
def filter_sites_without_proposal(data):
    return [(entry['web_domains'][0], entry['contract_address']) for entry in data if not entry.get('p8') and entry.get('p6') and entry.get('p6') == true and entry.get('web_domains')]
